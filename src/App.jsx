    ...
    <main className="bg-dakrBlue">
      <section className="min-h-screen w-full flex justify-center items-center">
        <div className="xl:max-w-2xl relative max-w-xs bg-darkGray font-manrope mx-auto rounded-2xl">
          ...
          <div
            className="hover:shadow-neon transition-shadow xl:w-20 xl:h-20  w-16 h-16 bg-neonGreen mx-auto rounded-full absolute right-0 left-0 -translate-y-2/4 flex justify-center items-center cursor-pointer "
            onClick={getQuote}
          >
